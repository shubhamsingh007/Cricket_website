...
<div class="progress">
  <div class="progress-bar progress-bar-striped bg-info" role="progressbar" style="width: 100%" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
		...
		<div class="container">
			...
			<br />
			<br />
			<h2 align="center">Search All-Rounders</h2><br />
			<div class="form-group">
				<div class="input-group">
				<h4 style="color:rgb(173, 29, 173)"><strong>Search</strong></h4>
					<input type="text" name="search_text" id="search_text" placeholder="Search by All-rounders Details" class="form-control" />
				</div>
			</div>
			<br />
			<div id="result"></div>
